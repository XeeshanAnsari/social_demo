                ...
                <div class="col-md-4"> 
                    ...
                    <div  id="signInBox" >
                        <form action="" method="post">
                            <input type="email" name="email" id="userNameInput" required placeholder="Email or user name"><br>
                            <input type="password" name="pass" id="userPassInput" required placeholder="Password">
